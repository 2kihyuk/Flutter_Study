...
import 'package:mapsnsproject/map/model/sns_post_data.dart';
import 'package:mapsnsproject/map/repository/marker_repository.dart';
...
///
class SnsFeedScreen extends ConsumerStatefulWidget {
  final int markerId;

  const SnsFeedScreen({required this.markerId, super.key});

  @override
  ConsumerState<SnsFeedScreen> createState() => _SnsFeedScreenState();
}

class _SnsFeedScreenState extends ConsumerState<SnsFeedScreen> {
                  ...
                  return Column(
                    children: [
                      Container(
                        ...
                        child: Image.network('${posts.imgPath}'),
                      ),
              ...
              postAsync.when(
                data: (posts) {
                  return ExpansionTile(
                    ...
                    children: [
                      Text('장소명 : ${posts.placeName}'),
                      Text('주소 : ${posts.formattedAddress}'),
                    ],
                  );
                },
                error: (e, _) => Center(child: Text('게시물 로드 실패: $e')),
