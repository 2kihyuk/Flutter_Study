...
import 'package:intl/intl.dart'; // 숫자 포맷팅을 위해
                ...
                children: [
                  ...
                  Expanded(
                    child: TextField(
                      ...
                      onChanged: (value) {
                        setState(() {
                          budget = formatCurrency(value); // 숫자 포맷팅
                          _budgetController.text = budget; // 포맷된 값을 다시 텍스트 필드에 설정
                          _budgetController.selection = TextSelection.fromPosition(TextPosition(offset: budget.length)); // 커서 위치 조정
                        });
                      },
                    ),
                  ),
